...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_FEEDRATE       65  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
 ...
 */
  ...
  #define HOLD_MULTIPLIER    1.00  // Scales down the holding current from run current
